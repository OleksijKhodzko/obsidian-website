...
[
    ...
    {trigger: "x'N", replacement: "x'^{\\nu}", options: "mA"},
    {trigger: "met", replacement: "g_{\\mu\\nu}", options: "mA"},
    {trigger: "Met", replacement: "g^{\\mu\\nu}", options: "mA"},
    {trigger: "xm", replacement: "x_{\\mu}", options: "mA"},
    {trigger: "xn", replacement: "x_{\\nu}", options: "mA"},
    {trigger: "xM", replacement: "x^{\\mu}", options: "mA"},
    {trigger: "xN", replacement: "x^{\\nu}", options: "mA"},
    {trigger: "xdm", replacement: "\\dot{x}_{\\mu}", options: "mA"},
    {trigger: "xdn", replacement: "\\dot{x}_{\\nu}", options: "mA"},
    {trigger: "xdM", replacement: "\\dot{x}^{\\mu}", options: "mA"},
    {trigger: "xdN", replacement: "\\dot{x}^{\\nu}", options: "mA"},
    ...
    {trigger: "|", replacement: "\\Bigg|_{${0:0}}^{$1}", options: "mA"},

    // Basic operations
    {trigger: "sr", replacement: "^{2}", options: "mA"},
	{trigger: "cb", replacement: "^{3}", options: "mA"},
    {trigger: "rd", replacement: "_{${0:-\\infty}}^{${1:+\\infty}}$2", options: "mA"},
    ...
    {trigger: /([^\\])(exp|log|ln)/, replacement: "[[0]]\\[[1]]\\left\\{\$0\\right\\}", options: "rmA"},
    ...
    {trigger: "oo", replacement: "\\circ $0", options: "mA"},
