...
# Parallel transport 
==Parallel transport of tensor== $Y$ over some curve $\Lambda$  ==is defined as a tensor field== $Y(x)$ such that the directional derivative over [[tangent vector]] of $\Lambda$ stays 0.
$$
